This is an address book app for storing personal contacts (names, telephone numbers). The user can add and delete contacts and search (filter) the working contact list.
...
You have to `cd` to the directory that contains the files, `npm install` to fetch the package dependencies, and then `npm start`.
